...
new Promise(function(my_fulfill,my_reject){
    ...
    return new Promise(function(resolve,my_reject){
        prompt("server ip address: [0.0.0.0]",0,function(serverip){
            //TODO: migrate util
    ...
    return new Promise(function(resolve,my_reject){
        prompt("client MAC address: [33:33:33:33:33:33:33]","33:33:33:33:33:33",function(num){
            ...
            dv.setUint32(28,0x605718f5)//mac address
            dv.setUint16(32,0x367e)// also
...
packet.on("listening",function(err){
console.log("this socket was binded!!")
})

packet.on("close",function(err){
